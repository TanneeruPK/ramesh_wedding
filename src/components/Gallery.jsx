...
const GALLERY_ITEMS = [
  {
    id: 1,
    gradient: "linear-gradient(135deg, #6B1C1C 0%, #C9A84C 50%, #4A0E0E 100%)",
    label: "The Beginning",
    aspect: "4/3",
  },
  {
    id: 2,
    gradient:
      "linear-gradient(135deg, #1a0a04 0%, #8B6914 40%, #C9A84C 70%, #6B1C1C 100%)",
    label: "A Beautiful Bond",
    aspect: "3/4",
  },
  {
    id: 3,
    gradient: "linear-gradient(135deg, #4A0E0E 0%, #C9A84C 60%, #8B2222 100%)",
    label: "Our Love Story",
    aspect: "4/3",
  },
  {
    id: 4,
    gradient: "linear-gradient(135deg, #0D0500 0%, #6B1C1C 50%, #F5D98B 100%)",
    label: "Together Forever",
    aspect: "3/4",
  },
  {
    id: 5,
    gradient: "linear-gradient(135deg, #8B6914 0%, #1A0A04 50%, #C9A84C 100%)",
    label: "Blessed Union",
    aspect: "4/3",
  },
  {
    id: 6,
    gradient: "linear-gradient(135deg, #6B1C1C 0%, #FFE97D 40%, #8B2222 100%)",
        ...
        >
          <motion.div
            ...
            style={{
              ...
              position: "relative",
              boxShadow:
                "0 0 60px rgba(201,168,76,0.2), 0 40px 80px rgba(0,0,0,0.8)",
            }}
          >
            <div
              style={{
