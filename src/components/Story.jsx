...
const STORY_ITEMS = [
  {
    ...
    desc: "In the beautiful tapestry of fate, two souls found each other — Ramesh  and Akhilaja. Their first meeting was a moment the universe had planned long before.",
  },
  {
    icon: "💛",
  ...
  },
  {
    ...
    desc: "With families united and hearts intertwined, Ramesh asked the question that would change their lives forever. She said yes — and a new chapter began.",
  },
  {
    icon: "🌹",
    year: "24 June 2026",
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at top, rgba(201,168,76,0.06), transparent 70%)",
            pointerEvents: "none",
          }}
        />
