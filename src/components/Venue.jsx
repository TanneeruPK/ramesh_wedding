...
const VENUES = [
  {
    ...
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Sri+Tara+Convention+Kompally+Hyderabad',
  ...
  },
  {
    ...
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Sri+Vasavi+Venugopala+Swamy+Kalyana+Mandapam+Durgi',
...
function VenueCard({ venue, index, inView }) {
  return (
    ...
    >
      ...
      <div style={{
        padding: '1.5rem',
        background: 'linear-gradient(135deg, rgba(107,28,28,0.4), rgba(201,168,76,0.1))',
        ...
        <p className="font-cinzel text-gold" style={{
          fontSize: '0.7rem', letterSpacing: '0.25em', opacity: 0.7, marginBottom: '0.25rem'
        }}>
          {venue.event}
        </p>
        <p className="font-cormorant text-cream" style={{
          fontSize: '0.95rem', fontStyle: 'italic', opacity: 0.6
        }}>
          {venue.date}
        </p>
      </div>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p className="font-cinzel text-gold" style={{ fontSize: '0.65rem', letterSpacing: '0.2em', opacity: 0.6 }}>
            LOCATION
          </p>
        </div>
      </div>
      ...
      <div style={{ padding: '1.5rem', textAlign: 'center' }}>
        <h3 className="font-playfair gold-gradient-text" style={{
          fontSize: 'clamp(1.2rem, 3vw, 1.6rem)', fontWeight: 600, marginBottom: '0.5rem'
        }}>
          {venue.name}
        </h3>
        <p className="font-cormorant text-cream" style={{
          fontSize: '1rem', fontStyle: 'italic', opacity: 0.65, marginBottom: '1.25rem'
        }}>
          📍 {venue.address}
        </p>

        <p className="font-cormorant text-gold" style={{
          fontSize: '0.9rem', fontStyle: 'italic', opacity: 0.6, marginBottom: '1.5rem',
          padding: '0.5rem',
...
function Venue() {
  ...
  return (
    <section id="venue" ref={ref} className="section-pad" style={{
      background: `
